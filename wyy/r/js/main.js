$(function () {
    var playerTrack = $("#player-track"),//播放信息
        bgArtwork = $("#bg-artwork"),//背景模糊图
        bgArtworkUrl,
        albumName = $("#album-name"),//歌曲名
        trackName = $("#track-name"),//歌手名
        albumArt = $("#album-art"),
        sArea = $("#s-area"),
        seekBar = $("#seek-bar"),
    ...
    function selectTrack2(flag) {
        //歌单详细见 https://api.uomg.com/doc-rand.music.html
        $.getJSON(
